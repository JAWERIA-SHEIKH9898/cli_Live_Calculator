...
console.log(chalk.red("\t\t\t\t\t<======="), chalk.bgWhite.red.italic.bold("CODE WITH JAWERIA SHEIKH"), chalk.red("=======>"));
console.log(chalk.green("\t\t           <--"), chalk.blue.italic.bold("WELCOME TO TIME LIVE CALCULATOR USING TYPESCRIPT AND INQUIRER"), chalk.green("-->\n"));
